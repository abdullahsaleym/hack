              ...
              .map((student) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div>
                      <p className="font-semibold uppercase tracking-wide mb-0.5" style={{ color: "#5a9ab0" }}>
                        Bootcamp
                      </p>
                  ...
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wide mb-1" style={{ color: "#5a9ab0" }}>
                      Quiz Score
                    </p>
                    <ScoreBar score={student.quizScore} total={student.quizTotal} />
                  </div>
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wide mb-0.5" style={{ color: "#5a9ab0" }}>
                      Top Knowledge Gap
                    </p>
                    <p
                      className="text-sm font-medium"
                      style={{
                        color: student.topGap.startsWith("None") ? "#10B981" : "#e2e8f0",
                      }}
                    >
                      {student.topGap}
                    </p>
